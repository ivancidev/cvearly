...
export function CVPreview({ cvData }: CVPreviewProps) {
  ...
  return (
    <div className="w-full bg-white text-zinc-900 rounded-2xl shadow-2xl p-8 sm:p-12 md:p-14 border border-zinc-200 aspect-[1/1.414] overflow-auto select-text font-sans cve-scroll">
      {/* Header section */}
