...
export function HowItWorks() {
  const steps = [
    {
      num: "01",
      title: "Paste job description & upload CV",
      desc: "Drop in the job offer and your current resume (.pdf, .docx, or .txt). We extract every keyword and skill the ATS scans for.",
      icon: (
    ...
    {
      num: "02",
      title: "Add your GitHub (Optional)",
      desc: "We analyze your repositories and commits to surface real projects, programming languages, and active open-source contributions.",
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      ...
      desc: "Get a beautifully formatted, recruiter-ready .docx document with a detailed ATS score and improvement checklist.",
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
